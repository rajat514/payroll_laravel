    ...
    'options' => [
        ...
        'font_family' => [
            ...
            'noto_sans_devanagari' => [
                'normal' => public_path('fonts/NotoSansDevanagari-Regular.ttf'),
                'bold' => public_path('fonts/NotoSansDevanagari-Bold.ttf'),
            ],
            'mangal' => [
                'normal' => public_path('fonts/MANGAL.TTF'),
                'bold' => public_path('fonts/MANGAL.TTF'),
            ],
        ],
    ],
