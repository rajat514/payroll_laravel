...
class BankSheet implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithTitle, WithEvents
{
    protected $filters;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue("G{$row}", $totalNetAmount);   // Net Amount
    ...
    public function headings(): array
    {
        return [
            ...
            'नाम/Name',
            'पद/Designation',
            'अंतिम शुद्ध वेतन/Final Net Amount',
        ];
    }
