...
class LicenseFeeSheet implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithTitle, WithEvents
{
    protected $filters;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $license_fee = $netSalaries->sum(fn($item) => $item->deduction->license_fee ?? 0);
                ...
                $sheet->setCellValue("E{$row}", $license_fee);  // Total Deductions
