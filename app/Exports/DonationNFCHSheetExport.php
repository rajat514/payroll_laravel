...
class DonationNFCHSheetExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithTitle, WithEvents
{
    protected $filters;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $nfch_donation = $netSalaries->sum(fn($item) => $item->deduction->nfch_donation ?? 0);
                ...
                // Gross Pay
                $sheet->setCellValue("F{$row}", $nfch_donation);  // Total Deduction
